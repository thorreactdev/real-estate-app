...
const{ id } = useParams();
  ...
  const handleImageSubmit = () => {
    if(files.length === 0){
        return setImageUploadError("Please Upload atleast 2 images");
    }
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button onClick={handleSubmit}  disabled={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
          {loading ? 'Wait Updating...' : 'Update listing'}
          </button>
